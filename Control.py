...
def Write(DevNum,keyList,valList):
    ...
    CommPort = Device_Identity['CommPort']
    deviceAddress = Device_Identity['Address']
    baudrate = Device_Identity['Baudrate']
    parity = Device_Identity['Parity']
    stopbit = Device_Identity['StopBit']
    bytesize = Device_Identity['ByteSize']
