...
DevPerPortList = {}
for devprofile in Dev_ID:
    did = Dev_ID.index(devprofile) + 1
    port = devprofile['CommPort']
    if not (port in DevPerPortList):
        DevPerPortList[port] = []
    DevPerPortList[port].append(did)
#print(DevPerPortList)
